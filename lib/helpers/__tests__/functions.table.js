...
test('testing parseDataForColumns(), should build the columns based on the object', () => {
  const sample = [
    {
      _id: 'id',
      address: {
  ...
  const parsedData = parseDataForColumns(sample, headers, orderedHeaders, hideUnordered)
